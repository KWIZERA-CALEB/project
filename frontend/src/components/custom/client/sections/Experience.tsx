  ...
  return (
    <section className="min-h-screen bg-gray-100 w-full p-[20px] md:p-20">
      ...
      <div className="bg-blue-600 w-full rounded-lg p-10 mb-10">
        {/* Small White Div */}
        <div className="bg-white w-16 h-16 flex justify-center cursor-pointer items-center rounded-lg shadow-lg mb-6">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width='30' height='30' fill="#2B71F0">
