...
const Integration = () => {
  return (
    <section className="bg-gray-50 py-16 px-6 sm:px-10 lg:px-20">
      <h2 className="text-xl sm:text-2xl font-bold text-center text-gray-900 mb-8 leading-snug">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 items-start gap-16">
        ...
        <div>
          <ul className="space-y-6 mt-5">
            ...
            <li className="flex items-center">
              <div className="flex-shrink-0 w-8 border-[1px] border-solid border-[#000] h-8 bg-blue-500 text-white rounded-full flex items-center justify-center font-semibold text-sm mr-4">
                1
              </div>
              <div>
        ...
        <div className="flex justify-center">
          <img
            src="/assets/images/challenges-dark-screen.png"
