    ...
    const navItems = [
        {
            navLink: '/control',
            navLabel: 'Dashboard',
            navIcon: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width='18' height='18' fill={currentPath === '/control' ? '#2B71F0' : '#fff'}>
        ...
        },
        {
            navLink: '/community',
            navLabel: 'Community',
            navIcon: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width='18' height='18' fill={currentPath === '/community' ? '#2B71F0' : '#fff'}>
